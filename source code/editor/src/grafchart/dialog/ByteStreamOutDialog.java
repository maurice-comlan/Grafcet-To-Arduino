...
import grafchart.sfc.ByteStreamOut;
...
public class ByteStreamOutDialog
  extends MyJDialog
{
  private MyJTextField tHost = new MyJTextField();
  private MyJTextField tPort = new MyJTextField();
  private GCDocument myObject;
  private ByteStreamOut s;
  
  public ByteStreamOutDialog(Frame paramFrame, GCDocument paramGCDocument, ByteStreamOut paramByteStreamOut, GCView paramGCView)
  {
    super(paramFrame, "ByteStreamOut");
    this.myObject = paramGCDocument;
    this.s = paramByteStreamOut;
    init();
    pack();
...
/* Location:              /home/dimon/GIT5/Memoire/JGrafchart/JGrafchart-2.6.1/lib/JGrafchart.jar!/grafchart/dialog/ByteStreamOutDialog.class

...
public class NewFuncBlockDialog extends MyJDialog {
    private final FunctionBlock variable;
    private JTextField nameField;
    private JComboBox<FunctionBlock.Language> langCombo;
    private JTextPane contentText;

    public NewFuncBlockDialog(Frame paramFrame, FunctionBlock var) {        
        super(paramFrame, "New Function Block", true);
        this.variable = var;        
        init();        
    ...
    private void updateDialog() {
        setTitle(this.variable.getName() + " - Function Block");

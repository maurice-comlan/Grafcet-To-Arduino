  ...
  implements Node
{
  ...
  public SimpleNode(TransitionParser paramTransitionParser, int paramInt)
  {
    this(paramInt);
  ...
  public Object childrenAccept(TransitionParserVisitor paramTransitionParserVisitor, Object paramObject)
  {
    if (this.children != null) {
      for (int i = 0; i < this.children.length; i++) {
        this.children[i].jjtAccept(paramTransitionParserVisitor, paramObject);
      }
    }
    return paramObject;
  }
  ...
  {
    return TransitionParserTreeConstants.jjtNodeName[this.id];
  }
...
/* Location:              /home/dimon/GIT5/Memoire/JGrafchart/JGrafchart-2.6.1/lib/JGrafchart.jar!/grafchart/sfc/transitions/SimpleNode.class

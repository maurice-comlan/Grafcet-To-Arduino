  ...
  implements Cloneable
{
  ...
  {
    Mult localMult = (Mult)super.clone();
    localMult.opToString_visited = -1;
    localMult.in$Circle(false);
    localMult.is$Final(false);
    return localMult;
  }
  ...
  public Mult copy()
  {
    try
    {
      Mult localMult = clone();
      if (this.children != null) {
        localMult.children = ((ASTNode[])this.children.clone());
      }
      return localMult;
    }
  ...
  public Mult fullCopy()
  {
    ...
    for (int i = 0; i < getNumChildNoTransform(); i++)
    {
      ...
      localMult.setChild(localASTNode, i);
    }
    return localMult;
  }
  ...
  public Mult(int paramInt)
  {
    super(paramInt);
  }
  
  public Mult(TransitionParser paramTransitionParser, int paramInt)
  {
    this(paramInt);
  ...
  public Mult(Expr paramExpr1, Expr paramExpr2)
  {
  ...
  {
    paramPrintStream.println(paramString + "Mult");
...
/* Location:              /home/dimon/GIT5/Memoire/JGrafchart/JGrafchart-2.6.1/lib/JGrafchart.jar!/grafchart/sfc/transitions/Mult.class

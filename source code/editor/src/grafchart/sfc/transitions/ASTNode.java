  ...
  implements Cloneable, Evaluatable, Iterable<T>
{
    ...
    throws CloneNotSupportedException
  {
    ...
    localASTNode.isString_visited = -1;
  ...
  public ASTNode(TransitionParser paramTransitionParser, int paramInt)
  {
    this(paramInt);
  ...
  public Start root()
  {
    ...
    Start localStart = getParent().Define_Start_root(this, null);
    this.root_visited = -1;
    return localStart;
  }
  ...
  {
    return getParent().Define_Start_root(this, paramASTNode1);
  }
...
/* Location:              /home/dimon/GIT5/Memoire/JGrafchart/JGrafchart-2.6.1/lib/JGrafchart.jar!/grafchart/sfc/transitions/ASTNode.class

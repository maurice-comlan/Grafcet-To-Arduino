  ...
  implements Cloneable
{
  ...
  {
    LT localLT = (LT)super.clone();
    localLT.opToString_visited = -1;
    localLT.in$Circle(false);
    localLT.is$Final(false);
    return localLT;
  }
  ...
  public LT copy()
  {
    try
    {
      ...
      if (this.children != null) {
        localLT.children = ((ASTNode[])this.children.clone());
      }
      return localLT;
    }
  ...
  public LT fullCopy()
  {
    ...
    for (int i = 0; i < getNumChildNoTransform(); i++)
    {
      ...
      localLT.setChild(localASTNode, i);
    }
    return localLT;
  }
  ...
  public LT(TransitionParser paramTransitionParser, int paramInt)
  {
    this(paramInt);
  ...
  public LT(Expr paramExpr1, Expr paramExpr2)
  {
  ...
  {
    paramPrintStream.println(paramString + "LT");
...
/* Location:              /home/dimon/GIT5/Memoire/JGrafchart/JGrafchart-2.6.1/lib/JGrafchart.jar!/grafchart/sfc/transitions/LT.class

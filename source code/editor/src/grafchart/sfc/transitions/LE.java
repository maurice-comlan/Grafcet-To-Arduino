  ...
  implements Cloneable
{
  ...
  {
    LE localLE = (LE)super.clone();
    localLE.opToString_visited = -1;
    localLE.in$Circle(false);
    localLE.is$Final(false);
    return localLE;
  }
  ...
  public LE copy()
  {
    try
    {
      ...
      if (this.children != null) {
        localLE.children = ((ASTNode[])this.children.clone());
      }
      return localLE;
    }
  ...
  public LE fullCopy()
  {
    ...
    for (int i = 0; i < getNumChildNoTransform(); i++)
    {
      ...
      localLE.setChild(localASTNode, i);
    }
    return localLE;
  }
  ...
  public LE(int paramInt)
  {
    super(paramInt);
  }
  
  public LE(TransitionParser paramTransitionParser, int paramInt)
  {
    this(paramInt);
  ...
  public LE(Expr paramExpr1, Expr paramExpr2)
  {
  ...
  {
    paramPrintStream.println(paramString + "LE");
...
/* Location:              /home/dimon/GIT5/Memoire/JGrafchart/JGrafchart-2.6.1/lib/JGrafchart.jar!/grafchart/sfc/transitions/LE.class

  ...
  implements Cloneable
{
    ...
    throws CloneNotSupportedException
  {
    ...
    localNumber.isString_visited = -1;
  ...
  public boolean evaluateBoolean()
  {
    ...
    try
    {
      i = (int)Double.parseDouble(getVALUE());
    }
    catch (Exception localException)
    {
      Utils.writeException(localException, "Number.evaluateBoolean(): illegal expression");
    }
    return i == 1;
  }
  ...
  public Number(TransitionParser paramTransitionParser, int paramInt)
  {
    this(paramInt);
...
/* Location:              /home/dimon/GIT5/Memoire/JGrafchart/JGrafchart-2.6.1/lib/JGrafchart.jar!/grafchart/sfc/transitions/Number.class

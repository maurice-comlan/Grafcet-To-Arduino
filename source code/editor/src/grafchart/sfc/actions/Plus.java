  ...
  implements Cloneable
{
  ...
  {
    return getLeft().evaluateString() + getRight().evaluateString();
  }
  ...
  public Plus(ActionParser paramActionParser, int paramInt)
  {
    this(paramInt);
...
/* Location:              /home/dimon/GIT5/Memoire/JGrafchart/JGrafchart-2.6.1/lib/JGrafchart.jar!/grafchart/sfc/actions/Plus.class

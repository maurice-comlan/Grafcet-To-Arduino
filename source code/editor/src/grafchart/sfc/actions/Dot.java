  ...
  implements Cloneable
{
  ...
  private void execute(Referencable paramReferencable, Utils.DataType paramDataType)
  {
    ...
    {
      String str = BuiltInFunctions.getError(localFunction.getID(), localFunction.argumentsToArray(), paramReferencable, BuiltInFunctions.Language.Action);
      if (str == null)
      {
  ...
  public Dot(ActionParser paramActionParser, int paramInt)
  {
    this(paramInt);
...
/* Location:              /home/dimon/GIT5/Memoire/JGrafchart/JGrafchart-2.6.1/lib/JGrafchart.jar!/grafchart/sfc/actions/Dot.class

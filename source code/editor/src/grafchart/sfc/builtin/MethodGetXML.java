  ...
  extends AbstractExecutable
{
  ...
  public String internalExecuteString(Evaluatable[] paramArrayOfEvaluatable, Object paramObject)
  {
    if ((paramObject instanceof XMLMessageIn))
    {
      ...
      return ((XMLMessageIn)localObject).rawMessage;
    }
    Object localObject = (XMLMessageOut)paramObject;
    return ((XMLMessageOut)localObject).getXML();
  }
...
/* Location:              /home/dimon/GIT5/Memoire/JGrafchart/JGrafchart-2.6.1/lib/JGrafchart.jar!/grafchart/sfc/builtin/MethodGetXML.class

...
public class FuncDPWSGetEvent
  extends AbstractExecutable
{
  public FuncDPWSGetEvent()
  {
    super("dpwsGetEvent", 2, BuiltInFunctions.Language.Action);
  }
  ...
  public String internalExecuteString(Evaluatable[] paramArrayOfEvaluatable, Object paramObject)
  {
    ...
    String str1 = paramArrayOfEvaluatable[1].evaluateString();
    DPWSOperation localDPWSOperation = localDPWSPortType.getOperation(str1);
    if (localDPWSOperation == null)
    {
      runtimeError("Illegal operation name \"" + str1 + "\"");
      return "";
    }
    if (localDPWSOperation.getOperationType() != OperationType.NOTIFICATION)
    {
      runtimeError("Illegal operation type for \"" + str1 + "\"");
      return "";
    }
    String str2 = localDPWSObject.getEvent(localDPWSOperation.getOutputAction());
    if (str2 == null)
    {
      runtimeError("No events available for \"" + str1 + "\"");
      return "";
    }
    return str2;
  }
    ...
    if (str1 == null)
    {
      ...
      if ((paramArrayOfEvaluatable[0] instanceof Expr))
      {
        ...
        else if ((localExpr.staticDecl() instanceof DPWSObject))
        {
          ...
          {
            str1 = null;
            if (localDPWSPortType != null)
            {
              String str2 = null;
              if ((paramArrayOfEvaluatable[1] instanceof StringExpr))
              {
                str2 = ((StringExpr)paramArrayOfEvaluatable[1]).getVALUE();
                DPWSOperation localDPWSOperation = localDPWSPortType.getOperation(str2);
                if (localDPWSOperation == null) {
...
/* Location:              /home/dimon/GIT5/Memoire/JGrafchart/JGrafchart-2.6.1/lib/JGrafchart.jar!/grafchart/sfc/builtin/FuncDPWSGetEvent.class

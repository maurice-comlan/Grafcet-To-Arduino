...
public class select_log
  implements LabCommSample
{
  private static final String name = "select_log";
  ...
  public static void encode(LabCommEncoder paramLabCommEncoder, select_t paramselect_t)
    throws IOException
  {
    paramLabCommEncoder.begin("select_log");
    select_t.encode(paramLabCommEncoder, paramselect_t);
    paramLabCommEncoder.end("select_log");
  }
    ...
    implements LabCommDispatcher
  {
    ...
    {
      return select_log.signature;
    }
    
    public void decodeAndHandle(LabCommDecoder paramLabCommDecoder, LabCommHandler paramLabCommHandler)
      throws Exception
    {
      ((select_log.Handler)paramLabCommHandler).handle_select_log(select_log.decode(paramLabCommDecoder));
    }
  }
  ...
  {
    public abstract void handle_select_log(select_t paramselect_t)
      throws Exception;
  }
}


/* Location:              /home/dimon/GIT5/Memoire/JGrafchart/JGrafchart-2.6.1/lib/JGrafchart.jar!/se/lth/control/orca/select_log.class

...
public class select_output
  implements LabCommSample
{
  private static final String name = "select_output";
  ...
  public static void encode(LabCommEncoder paramLabCommEncoder, select_t paramselect_t)
    throws IOException
  {
    paramLabCommEncoder.begin("select_output");
    select_t.encode(paramLabCommEncoder, paramselect_t);
    paramLabCommEncoder.end("select_output");
  }
    ...
    implements LabCommDispatcher
  {
    ...
    {
      return select_output.signature;
    }
    
    public void decodeAndHandle(LabCommDecoder paramLabCommDecoder, LabCommHandler paramLabCommHandler)
      throws Exception
    {
      ((select_output.Handler)paramLabCommHandler).handle_select_output(select_output.decode(paramLabCommDecoder));
    }
  }
  ...
  {
    public abstract void handle_select_output(select_t paramselect_t)
      throws Exception;
  }
}


/* Location:              /home/dimon/GIT5/Memoire/JGrafchart/JGrafchart-2.6.1/lib/JGrafchart.jar!/se/lth/control/orca/select_output.class

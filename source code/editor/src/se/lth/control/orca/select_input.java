...
public class select_input
  implements LabCommSample
{
  private static final String name = "select_input";
  ...
  public static void encode(LabCommEncoder paramLabCommEncoder, select_t paramselect_t)
    throws IOException
  {
    paramLabCommEncoder.begin("select_input");
    select_t.encode(paramLabCommEncoder, paramselect_t);
    paramLabCommEncoder.end("select_input");
  }
    ...
    implements LabCommDispatcher
  {
    ...
    {
      return select_input.signature;
    }
    
    public void decodeAndHandle(LabCommDecoder paramLabCommDecoder, LabCommHandler paramLabCommHandler)
      throws Exception
    {
      ((select_input.Handler)paramLabCommHandler).handle_select_input(select_input.decode(paramLabCommDecoder));
    }
  }
  ...
  {
    public abstract void handle_select_input(select_t paramselect_t)
      throws Exception;
  }
}


/* Location:              /home/dimon/GIT5/Memoire/JGrafchart/JGrafchart-2.6.1/lib/JGrafchart.jar!/se/lth/control/orca/select_input.class
